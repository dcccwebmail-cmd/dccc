...
const AdminSaveToast: React.FC = () => {
  ...
  return (
    ...
    >
      <div className={`flex items-center gap-3 text-white font-semibold py-3 px-6 rounded-full shadow-lg whitespace-nowrap max-w-[95vw] ${isSuccess ? 'bg-green-500' : 'bg-red-500'}`}>
        {isSuccess ? (
